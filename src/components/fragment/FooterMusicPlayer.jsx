        ...
        <div style={useStyle.component} className="footer-player">
            <div className="playback">
                {
                    ...
                    <ThemeProvider theme={muiTheme }>
                        <Slider className="playback-completed" size="small" value={seekTime} onChange={handleSeekChange}/>
                    </ThemeProvider>
                }
            </div>
            <Button
                    ...
                    className="curr-music-container" style={{ backgroundColor: "#0f1e36"}}>
            ...
            <div className="playback-controls">
                ...
                <ControlsToggleButton style={pointer} type={"prev"}
                                      ...
                                      onClicked={handleToggle}/>
                                      {/* This is where you play the songs man */}
